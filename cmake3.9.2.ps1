...
Write-Host "Installing CMake 3.9.2 ..." -ForegroundColor Cyan
$msiPath = "$($env:TEMP)\cmake-3.9.2-win32-x86.msi"

Write-Host "Downloading..."
(New-Object Net.WebClient).DownloadFile('https://cmake.org/files/v3.9/cmake-3.9.2-win32-x86.msi', $msiPath)
...
Write-Host "CMake 3.9.2 installed" -ForegroundColor Green
